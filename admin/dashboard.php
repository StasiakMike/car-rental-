...
<head>
    ...
    <title>MvdB Car4Rent | Admin Zone</title>
</head>

<body>
    <div class="col-12">
        <h1 class="text-center font-weight-bold p-5">BOOKINGS</h1>
        <div class="text-center">
            <a href="../index.php" class="m-2">BACK</a> | <a href="logout.php" class="m-2">LOGOUT</a>
        </div>
    </div>
